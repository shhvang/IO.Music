...
from IOMusic.utils.database import get_loop
from IOMusic.utils.decorators import AdminRightsCheck
from IOMusic.utils.inline import close_markup, stream_markup
...
@app.on_message(filters.command('ey io skip', prefixes='H') & filters.group & ~BANNED_USERS)
@AdminRightsCheck
