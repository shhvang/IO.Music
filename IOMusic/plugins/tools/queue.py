...
from IOMusic.utils import IOBin, get_channeplayCB, seconds_to_min
from IOMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from IOMusic.utils.decorators.language import language, languageCB
from IOMusic.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://telegra.ph/file/cb1947522c0de4c4a63e8.jpg",
        caption=_["queue_1"],
    )
